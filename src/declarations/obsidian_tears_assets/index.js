...
import { idlFactory } from './obsidian_tears_assets.did.js';
export { idlFactory } from './obsidian_tears_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.OBSIDIAN_TEARS_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./obsidian_tears_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the obsidian_tears_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./obsidian_tears_assets.did.js")._SERVICE>}
 */
export const obsidian_tears_assets = createActor(canisterId);
