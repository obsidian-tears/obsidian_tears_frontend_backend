...
import { idlFactory } from './obsidian_tears_frontend.did.js';
export { idlFactory } from './obsidian_tears_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.OBSIDIAN_TEARS_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./obsidian_tears_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the obsidian_tears_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./obsidian_tears_frontend.did.js")._SERVICE>}
 */
export const obsidian_tears_frontend = createActor(canisterId);
