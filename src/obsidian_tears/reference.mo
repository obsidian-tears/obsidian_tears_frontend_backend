...
module Reference = {
    ...
    */
    ...
    public let items : [Item] = [
        ...
        { id=17; name="Fire Wand";                    unityId="2148976045";   metadata=[];         ableClasses=[0,1,2]; tier=0 },
        ...
        { id=25; name="\"Thors Hammer\"";             unityId="4030616533";   metadata=[3,0,18,0]; ableClasses=[0,1,2]; tier=1 },
        { id=26; name="Amethyst Pendant";             unityId="1931403643";   metadata=[3,2,3,0];  ableClasses=[0,1,2]; tier=1 },
        { id=27; name="Apple";                        unityId="745643686";    metadata=[3,2,12,0]; ableClasses=[0,1,2]; tier=1 },
        { id=28; name="Black Ribboned Magic Staff";   unityId="625332779";    metadata=[3,0,11,0]; ableClasses=[0,1,2]; tier=1 },
        { id=29; name="Blue Leaf Ring";               unityId="481000799";    metadata=[3,2,5,0];  ableClasses=[0,1,2]; tier=1 },
        { id=30; name="Blue Potion Full";             unityId="2855010320";   metadata=[3,2,13,0]; ableClasses=[0,1,2]; tier=1 },
        { id=31; name="Bow";                          unityId="363272315";    metadata=[3,0,2,0];  ableClasses=[0,1,2]; tier=1 },
        { id=32; name="Bread";                        unityId="1030250569";   metadata=[3,2,14,0]; ableClasses=[0,1,2]; tier=1 },
        { id=33; name="Bronze Knuckles";              unityId="3950828821";   metadata=[3,0,9,0];  ableClasses=[0,1,2]; tier=1 },
        { id=34; name="Cauldron Lid";                 unityId="3751818968";   metadata=[3,1,9,0];  ableClasses=[0,1,2]; tier=1 },
        { id=35; name="Dark Beoite Heart";            unityId="4290235510";   metadata=[3,2,15,0]; ableClasses=[0,1,2]; tier=1 },
        { id=36; name="Dukor's Blade";                unityId="2847687731";   metadata=[3,0,0,0];  ableClasses=[0,1,2]; tier=1 },
        { id=37; name="Dwarven Battle Axe";           unityId="1037042359";   metadata=[3,0,7,0];  ableClasses=[0,1,2]; tier=1 },
        { id=38; name="Extraordinarily Big Stick";    unityId="1904791833";   metadata=[3,0,21,0]; ableClasses=[0,1,2]; tier=1 },
        { id=39; name="Fire Katana";                  unityId="418848405";    metadata=[3,0,8,0];  ableClasses=[0,1,2]; tier=1 },
        { id=40; name="Fireblast";                    unityId="3626749823";   metadata=[3,2,16,0]; ableClasses=[0,1,2]; tier=1 },
        { id=41; name="FireDrain";                    unityId="2724998409";   metadata=[3,0,17,0]; ableClasses=[0,1,2]; tier=1 },
        { id=42; name="Gold Chestplate";              unityId="726343602";    metadata=[3,1,2,0];  ableClasses=[0,1,2]; tier=1 },
        { id=43; name="Gold Helmet";                  unityId="2655242436";   metadata=[3,1,5,0];  ableClasses=[0,1,2]; tier=1 },
        { id=44; name="Golden Bow";                   unityId="3826446335";   metadata=[3,0,3,0];  ableClasses=[0,1,2]; tier=1 },
        { id=45; name="Green Leaf Ring";              unityId="810689207";    metadata=[3,2,6,0];  ableClasses=[0,1,2]; tier=1 },
        { id=46; name="Half Blue Potion";             unityId="484278545";    metadata=[3,2,18,0]; ableClasses=[0,1,2]; tier=1 },
        { id=47; name="Half Red Potion";              unityId="1037437805";   metadata=[3,2,19,0]; ableClasses=[0,1,2]; tier=1 },
        { id=48; name="Iron Chestplate";              unityId="653732320";    metadata=[3,1,3,0];  ableClasses=[0,1,2]; tier=1 },
        { id=49; name="Iron Helmet";                  unityId="4289281774";   metadata=[3,1,6,0];  ableClasses=[0,1,2]; tier=1 },
        { id=50; name="Iron Sword";                   unityId="976575711";    metadata=[3,0,16,0]; ableClasses=[0,1,2]; tier=1 },
        { id=51; name="Leather Boots";                unityId="1081105223";   metadata=[3,1,1,0];  ableClasses=[0,1,2]; tier=1 },
        { id=52; name="Leather Helmet";               unityId="1280933307";   metadata=[3,1,7,0];  ableClasses=[0,1,2]; tier=1 },
        { id=53; name="Lu Bu Karma Dagger";           unityId="2704662173";   metadata=[3,0,10,0]; ableClasses=[0,1,2]; tier=1 },
        { id=54; name="Melyn'tyl's Leather Armor";    unityId="2303056671";   metadata=[3,1,10,0]; ableClasses=[0,1,2]; tier=1 },
        { id=55; name="Metal Boots";                  unityId="1577743681";   metadata=[3,1,11,0]; ableClasses=[0,1,2]; tier=1 },
        { id=56; name="MeteorStrike";                 unityId="4240610747";   metadata=[3,1,9,0];  ableClasses=[0,1,2]; tier=1 },
        { id=57; name="Monster Jaw";                  unityId="3666317515";   metadata=[];         ableClasses=[0,1,2]; tier=0 },
        { id=58; name="Obsidian Boots";               unityId="1757689377";   metadata=[3,1,12,0]; ableClasses=[0,1,2]; tier=1 },
        { id=59; name="Obsidian Bow";                 unityId="3212510752";   metadata=[3,0,4,0];  ableClasses=[0,1,2]; tier=1 },
        { id=60; name="Obsidian Chestplate";          unityId="27490735";     metadata=[3,1,4,0];  ableClasses=[0,1,2]; tier=1 },
        { id=61; name="Obsidian Helmet";              unityId="1702382863";   metadata=[3,1,8,0];  ableClasses=[0,1,2]; tier=1 },
        { id=62; name="Obsidian Katana";              unityId="1470818698";   metadata=[3,0,1,0];  ableClasses=[0,1,2]; tier=1 },
        { id=63; name="Pendant of Memories";          unityId="2561442878";   metadata=[];         ableClasses=[0,1,2]; tier=0 },
        { id=64; name="Pendant of Swiftness";         unityId="2777492979";   metadata=[3,2,2,0];  ableClasses=[0,1,2]; tier=1 },
        { id=65; name="Pendant of Vitality";          unityId="2684748356";   metadata=[3,2,4,0];  ableClasses=[0,1,2]; tier=1 },
        { id=66; name="Pitchfork";                    unityId="2552016915";   metadata=[3,0,22,0]; ableClasses=[0,1,2]; tier=1 },
        { id=67; name="Reanimate Essence";            unityId="303085544";    metadata=[3,0,20,0]; ableClasses=[0,1,2]; tier=1 },
        { id=68; name="Red Potion Full";              unityId="1722848991";   metadata=[3,2,21,0]; ableClasses=[0,1,2]; tier=1 },
        { id=69; name="Ring of Quiet Incantation";    unityId="4168598264";   metadata=[3,0,7,0];  ableClasses=[0,1,2]; tier=1 },
        { id=70; name="Rune of Doom";                 unityId="1144956306";   metadata=[];         ableClasses=[0,1,2]; tier=0 },
        { id=71; name="Shard of Light";               unityId="677479500";    metadata=[];         ableClasses=[0,1,2]; tier=0 },
        { id=72; name="Shield of the Dragon Hearted"; unityId="2903559949";   metadata=[3,1,13,0]; ableClasses=[0,1,2]; tier=1 },
        { id=73; name="Silver Bow";                   unityId="2714621056";   metadata=[3,0,5,0];  ableClasses=[0,1,2]; tier=1 },
        { id=74; name="Smokescreen";                  unityId="1909245789";   metadata=[3,2,10,0]; ableClasses=[0,1,2]; tier=1 },
        { id=75; name="Soldiers Buckler";             unityId="2247105907";   metadata=[3,2,14,0]; ableClasses=[0,1,2]; tier=1 },
        { id=76; name="Soldiers Spear";               unityId="322747819";    metadata=[3,0,6,0];  ableClasses=[0,1,2]; tier=1 },
        { id=77; name="Spell of Healing";             unityId="2448034475";   metadata=[3,2,22,0]; ableClasses=[0,1,2]; tier=1 },
        { id=78; name="Splash";                       unityId="3601711013";   metadata=[3,0,8,0];  ableClasses=[0,1,2]; tier=1 },
        { id=79; name="Steel Halberd";                unityId="1268234594";   metadata=[3,0,23,0]; ableClasses=[0,1,2]; tier=1 },
        { id=80; name="Sunlit Blade";                 unityId="3253817716";   metadata=[3,0,15,0]; ableClasses=[0,1,2]; tier=1 },
        { id=81; name="Teardrop Staff";               unityId="3409749986";   metadata=[3,0,12,0]; ableClasses=[0,1,2]; tier=1 },
        { id=82; name="The ArchMages staff";          unityId="3607184235";   metadata=[3,0,24,0]; ableClasses=[0,1,2]; tier=1 },
        { id=83; name="The Chained Orb";              unityId="1629230594";   metadata=[3,2,0,0];  ableClasses=[0,1,2]; tier=1 },
        { id=84; name="The Champions Falchion";       unityId="1497491615";   metadata=[3,0,20,0]; ableClasses=[0,1,2]; tier=1 },
        { id=85; name="The Dreambinder's Blades";     unityId="2958353128";   metadata=[3,0,19,0]; ableClasses=[0,1,2]; tier=1 },
        { id=86; name="The Manawell Pendant";         unityId="1166711137";   metadata=[3,2,1,0];  ableClasses=[0,1,2]; tier=1 },
        { id=87; name="Thunder Charge";               unityId="806237574";    metadata=[3,2,23,0]; ableClasses=[0,1,2]; tier=1 },
        { id=88; name="Very Shiny Boots";             unityId="1511011266";   metadata=[3,1,15,0]; ableClasses=[0,1,2]; tier=1 },
        { id=89; name="Waterknot";                    unityId="3421549664";   metadata=[3,0,11,0]; ableClasses=[0,1,2]; tier=1 },
        { id=90; name="Wooden Sword";                 unityId="2069047119";   metadata=[3,0,25,0]; ableClasses=[0,1,2]; tier=1 },
        { id=91; name="Woodland Staff";               unityId="2564641913";   metadata=[3,0,13,0]; ableClasses=[0,1,2]; tier=1 },
        { id=92; name="Yam";                          unityId="3366400426";   metadata=[3,2,24,0]; ableClasses=[0,1,2]; tier=1 },
    ];
