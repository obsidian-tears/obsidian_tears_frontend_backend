export const itemIdlFactory = ({ IDL }) => {
  ...
  const ObsidianTearsItems = IDL.Service({
    '_mintNftsFromArray' : IDL.Func(
        [IDL.Vec(IDL.Vec(IDL.Nat8))],
        [],
        ['oneway'],
      ),
    'acceptCycles' : IDL.Func([], [], []),
    'addWhitelistWallets' : IDL.Func(
        [IDL.Vec(AccountIdentifier)],
        [],
        ['oneway'],
      ),
    ...
    'mintItem' : IDL.Func(
        [IDL.Vec(IDL.Nat8), AccountIdentifier],
        [],
        ['oneway'],
      ),
    ...
    'transferTokensToUser' : IDL.Func(
        [IDL.Vec(TokenIndex), AccountIdentifier],
        [],
        ['oneway'],
      ),
    'updateMetadata' : IDL.Func([IDL.Nat32, IDL.Vec(IDL.Nat8)], [], ['oneway']),
  ...
  return ObsidianTearsItems;
};


export const characterIdlFactory = ({ IDL }) => {
  const AccountIdentifier = IDL.Text;
  const SubAccount = IDL.Vec(IDL.Nat8);
  const TokenIndex = IDL.Nat32;
  const Settlement = IDL.Record({
  ...
  const ObsidianTears = IDL.Service({
    '_mintNftsFromArray' : IDL.Func(
        [IDL.Vec(IDL.Vec(IDL.Nat8))],
        [],
        ['oneway'],
    ...
    'balance' : IDL.Func([BalanceRequest], [BalanceResponse], ['query']),
    'bearer' : IDL.Func([TokenIdentifier__1], [Result_7], ['query']),
    'burnRemainingNfts' : IDL.Func([], [IDL.Vec(TokenIndex)], []),
    'clearPayments' : IDL.Func([IDL.Principal, IDL.Vec(SubAccount)], [], []),
    'cronCapEvents' : IDL.Func([], [], []),
    'cronDisbursements' : IDL.Func([], [], []),
    'cronSalesSettlements' : IDL.Func([], [], []),
